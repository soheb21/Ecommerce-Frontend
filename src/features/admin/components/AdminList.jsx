...
import { fetchAllBrandsAsync, fetchAllCategoriesAsync, fetchProductsByFiltersAsync, selectAllBrands, selectAllcategory, selectAllProducts, selectTotalItems } from "../../product-list/productSlice"
...
export default function AdminList() {
    ...
    }, [dispatch, filter, sort, page, category, brands]);
                    ...
                    >
                        ...
                        {Array.from({ length: totalPages }).map((ele, index) => (
                            ...
                            <div key={index}
                                ...
                                aria-current="page"
                                className={`relative z-10 cursor-pointer inline-flex items-center ${index + 1 === page ? `bg-pink-600 text-white` : 'bg-white text-pink-500'}  px-4 py-2 text-sm font-semibold focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink-600`}
                            >
                                {index + 1}
                            </div>
