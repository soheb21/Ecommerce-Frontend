...
import { fetchAllBrandsAsync, fetchAllCategoriesAsync, fetchProductsByFiltersAsync, fetchProductsBySearchAsync, selectAllBrands, selectAllcategory, selectAllProducts, selectTotalItems } from "./productSlice"
...
export default function Product() {
  ...
  const SearchInput = (e) => {
    ...
    if (searchData) {
      ...
      dispatch(fetchProductsBySearchAsync({ search: searchData }));
    }
    else {
      const pagination = { _page: page, _limit: ITEMS_PER_PAGE }
      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-4 pt-24">
            <form className="d-flex text-2xl mx-2  md:text-4xl font-bold tracking-tight text-gray-900" role="search">
              <input className="border-pink-500  " onChange={(e) => SearchInput(e)} type="search" placeholder="Search"  />
              <button className="text-pink-500 mt-4 md:mx-4" onClick={SearchInput}>Search</button>
            </form>
          ...
          {/* section of product and filters ends  pagination*/}
